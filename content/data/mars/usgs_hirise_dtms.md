...
The process of HiRISE DTM generation using SOCET SET (® BAE Systems) has evolved as additional data have been collected, software has been improved, and processing techniques have been refined {{ cite "Kirk:2008,Kirk:2020,Sutton:2022"}}. Therefore, one must be cognizant of the time at which a particular DTM was generated; different processing pipelines naturally lead to different presentations of artifacts and errors. 
...
It looks like a change happened somewhere after 2008 and before 2020. Is this a date that we should highlight?
